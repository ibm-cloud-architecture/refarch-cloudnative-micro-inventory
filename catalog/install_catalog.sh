...
function install_catalog {
	...
	printf "\n\n${grn}Installing Catalog Application. This will take a few minutes...${end} ${coffee3}\n\n"
...
printf "\nThen open a browser window and paste the following URL to see the Services created by Catalog Chart:\n"
