...
docker tag cloudnative/inventory-jenkins registry.ng.bluemix.net/chrisking/inventory:${build_number}
docker push registry.ng.bluemix.net/chrisking/inventory:${build_number}
